...
/**
 * <h1>Allows to get the usr location</h1>
 * */
public class DeviceLocation extends Service implements LocationListener {
    private final Context mContext;
    private static String TAG=DeviceLocation.class.getSimpleName();
    // flag for GPS status
    ...
    /**
     * Returns Location object with current latitude and longitude
     */
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            try {
                locationManager.removeUpdates(DeviceLocation.this);
            }catch (SecurityException e){
